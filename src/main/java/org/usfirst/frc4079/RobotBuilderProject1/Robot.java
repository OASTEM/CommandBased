...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        chooser.addObject("Drive Distance", new DriveDistance(111.32, 4.5));
        chooser.addObject("Turn By Angle", new TurnByAngle(90, 3.0));
        chooser.addObject("Drive To Lamp Post", new DriveToLampPost());
        chooser.addObject("Elevator PID", new RaiseElevatorToHeight(900, 1.0));
