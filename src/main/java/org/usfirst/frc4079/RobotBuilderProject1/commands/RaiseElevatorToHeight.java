...
public class RaiseElevatorToHeight extends Command {
    ...
    public RaiseElevatorToHeight(double height, double duration) {
    ...
    protected void initialize() {
        Robot.elevator.enableController();
    }

    // Called repeatedly when this Command is scheduled to run
    @Override
    protected void execute() {
    	Robot.elevator.raiseToHeight(height);
    ...
    protected void end() {
        Robot.elevator.stop();
        Robot.elevator.disableController();
    }
